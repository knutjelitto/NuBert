...
namespace Pliant.Tests.Unit.Automata
{
    ...
    public class SubsetConstructionAlgorithmTests
    {
        ...
        public void SubsetConstructionAlgorithmShouldConvertSingleCharacterNfaToEquivalentDfa()
        {
            ...
            states[0].AddTransition(new TerminalNfaTransition(a, states[1]));
        ...
        public void SubsetConstructionAlgorithmShouldConvertComplexNfaToDfa()
        {
            ...
            states[0].AddTransition(new TerminalNfaTransition(a, states[1]));
            states[0].AddTransition(new TerminalNfaTransition(c, states[3]));
            states[1].AddTransition(new NullNfaTransition(states[0]));
            states[1].AddTransition(new TerminalNfaTransition(b, states[2]));
            states[2].AddTransition(new TerminalNfaTransition(a, states[1]));
            states[3].AddTransition(new TerminalNfaTransition(c, states[2]));
            states[3].AddTransition(new NullNfaTransition(states[2]));
